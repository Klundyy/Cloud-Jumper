class Platformer extends Phaser.Scene {
    ...
    create() {
        this.roomGen = false;
        this.map = this.add.tilemap("cloudlevel", 18, 18, 75, 25);

        // Add a tileset to the map
        // First parameter: name we gave the tileset in Tiled
        // Second parameter: key for the tilesheet (from this.load.image in Load.js)
        this.tileset = this.map.addTilesetImage("basetiles", "tilemap_tiles");
        this.bgtileset = this.map.addTilesetImage("background", "tilemap_background_tiles");
